...
const auto kProbeSpecs = MakeArray<bpf_tools::KProbeSpec>({
    ...
    // TODO(ddelnano): Consider if these should be optional.
    ...
    {"tcp_sendmsg", ProbeType::kEntry, "probe_entry_populate_active_connect_sock", /*is_syscall*/ false},
    {"tcp_sendmsg", ProbeType::kReturn, "probe_ret_populate_active_connect_sock", /*is_syscall*/ false},
