...
const auto kProbeSpecs = MakeArray<bpf_tools::KProbeSpec>({
    ...
    {"security_socket_sendmsg", ProbeType::kEntry, "probe_entry_socket_sendmsg",
     ...
     std::make_shared<bpf_tools::KProbeSpec>(bpf_tools::KProbeSpec{"sock_sendmesg", ProbeType::kEntry, "probe_entry_socket_sendmsg",
                               false, true})},
    {"security_socket_recvmsg", ProbeType::kEntry, "probe_entry_socket_recvmsg",
     /*is_syscall*/ false, /* is_optional */ false,
     std::make_shared<bpf_tools::KProbeSpec>(bpf_tools::KProbeSpec{"sock_recvmsg", ProbeType::kEntry, "probe_entry_socket_recvmsg",
                               false, true})},
});
