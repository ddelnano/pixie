...
const auto kProbeSpecs = MakeArray<bpf_tools::KProbeSpecWithFallback>({
    bpf_tools::KProbeSpecWithFallback{.kernel_fn = "connect", .attach_type = ProbeType::kEntry, .probe_fn = "syscall__probe_entry_connect"},
    ...
    /*      "sock_sendmesg", ProbeType::kEntry, "probe_entry_socket_sendmsg", false, false}}, */
    bpf_tools::KProbeSpecWithFallback{.kernel_fn = "security_socket_recvmsg", .attach_type = ProbeType::kEntry, .probe_fn = "probe_entry_socket_recvmsg",
     .is_syscall = false, .is_optional = false, .fallback_probe = bpf_tools::KProbeSpec{
         .kernel_fn = "sock_recvmsg", .attach_type = ProbeType::kEntry, .probe_fn = "probe_entry_socket_recvmsg", .is_syscall = false, .is_optional = false}},
});
