...
class Go1_25_TLSServerContainer : public ContainerRunner {
 public:
  Go1_25_TLSServerContainer()
      : ContainerRunner(::px::testing::BazelRunfilePath(kBazelImageTar), kContainerNamePrefix,
                        kReadyMessage) {}

  static constexpr std::string_view kBazelImageTar =
      "src/stirling/testing/demo_apps/go_https/server/golang_1_25_https_server.tar";
