...
class Go1_25_TLSClientContainer : public ContainerRunner {
 public:
  Go1_25_TLSClientContainer()
      : ContainerRunner(::px::testing::BazelRunfilePath(kBazelImageTar), kContainerNamePrefix,
                        kReadyMessage) {}

 private:
  static constexpr std::string_view kBazelImageTar =
      "src/stirling/testing/demo_apps/go_https/client/golang_1_25_https_client.tar";
