...
// tried to parse a server_name extension that had a lenght of 0.
constexpr uint8_t kValidTLSv1_2ServerHello[] = {
...
TEST_F(TLSParserTest, ParseValidTLSv_1_2ServerHello) {
  auto frame_view = CreateStringView<char>(CharArrayStringView<uint8_t>(kValidTLSv1_2ServerHello));
