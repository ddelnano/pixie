...
#else
typedef ::testing::Types<Node12_3_1ContainerWrapper, Node14_18_1AlpineContainerWrapper> OpenSSLServerNewImplImplementations;
#endif
...
#define OPENSSL_TYPED_TEST(TestCase, CodeBlock)       \
  TYPED_TEST(OpenSSLTraceNewImpl, TestCase) \
  CodeBlock
