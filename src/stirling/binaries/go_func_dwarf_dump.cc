...
/* void ArgInfo::ToJSON(::px::utils::JSONObjectBuilder* builder) const { */
/*   builder->WriteKV("offset", location.offset); */
/*   /1* builder->WriteKV("location", location.loc_type); *1/ */
...
int main(int argc, char** argv) {
  ...
  /* std::map<std::string, FuncArgsAndRets> args; */
  ...
  /*   LOG(error) << absl::Substitute(err_msg, FLAGS_pprof_pb_file); */
  /* } */
}
