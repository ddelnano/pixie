...
TEST_F(FilterNodeTest, basic) {
  ...
  tester
      .ConsumeNext(RowBatchBuilder(input_rd, 4, /*eow*/ false, /*eos*/ false)
                       ...
                       .AddColumn<types::StringValue>({"", "DEF", "HELLO", "WORLD"})
                       .get(),
                   0)
